...
<body>
    ...
    <div class="page-wrapper">
      ...
      <!-- Funfacts Section -->
      <?php include('include/facts-section.php'); ?>
            ...
            <div class="auto-container">
                <div class="row clearfix">
                            ...
                            <div class="default-tabs tabs-box">
                                ...
                                <div class="tabs-content">
                                    ...
                                    <div class="tab active-tab" id="tab-1">
                                        <div class="content">
                                            <div class="text">Our vision is to develop in a constant manner and grow as a major IT service provider to become a leading performer, in providing quality Web and Software Development solutions in the competitive global marketplace.</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab" id="tab-2">
                                        <div class="content">
                                            <div class="text">We offer a phased approach towards your business drivers and help IT organizations to align their goals towards the overall vision of the business.</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab" id="tab-3">
                                        <div class="content">
                                            <div class="text">Together with planning and creating your web nearness, we propose business-oriented arrangements that fit your needs and talk volumes of your values as a brand.</div>
                                        </div>
                                    </div>
                    ...
                    <div class="right-col col-xl-6 col-lg-12 col-md-12 col-sm-12">
                        <div class="inner">
                            <div class="text">Our accentuation is on advertising a high degree of item client invitingness through a positive, inventive and centered company staff.</div>
                            <div class="featured-block-two clearfix">
                                <div class="image"><img src="images/resource/featured-image-6.jpg" alt=""></div>
                                <div class="text">
                                    <ul>
                                        <li>Among a plenty of administrations.</li>
                                        <li>Business-to-business applications.</li>
                                        <li>Business-to-clients applications.</li>
                                        <li>Technagers is to develop and promote advanced information and technlogies.</li>
